...
console.log('Suming , All subarray while Lopping: - ',sumAllSubArrayNewApproch([1, 2, 3]));


// memory efficent formula O(n) times
...
console.log('Each contribution: ', sumOfAllArrayInContribution([1, 2, 3]));